...
const Ministry = () => {
    ...
    <section id="featured-videos">
        <div class="container">
          ...
          <div class="video-container">
            <div class="videos">
              <h2 class="header">Teaching Ministry</h2>
  ...
  CONTENDING FOR THE FAITH By Prophet Kevin N. </h3>
              ...
              <h2 class="header">Healing Ministry</h2>
  ...
  CONTENDING FOR THE FAITH By Prophet Kevin N. </h3>
              ...
              {/* <!-- prophetic mandate --> */}
              <h2 class="header">Prophetic Ministry</h2>
            ...
            <div class="side-news">
              <div class="side-news-card">
                ...
                <div class="side-news-text">
                  ...
                  <a href="" class="btn">Receive Christ</a>
                </div>
              </div>
              <div class="subscribe">
                <div>
              ...
              <div class="side-news-card">
                ...
                <div class="side-news-text">
                  ...
                  <a href="../partner/partner.html" class="btn">Become a partner</a>
                </div>
              </div>
            </div>
          </div>
