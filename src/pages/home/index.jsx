...
const Home = () => {
  return (
        ...
        <div class="even-columns">
          <div>
            ...
            <div class="btn-container">
              <a href="./about/agm" class="btn btn-white">Learn More</a>
              <a href="./contact/prayerrequests" class="btn">Contact Us</a>
            </div>
          </div>
          <div>
            <img src={tower} alt=""
    ...
    <section id="featured-content">
      <div class="container">
        <h2 class="header">Featured Content</h2>
        <h3>Q & A</h3>
        ...
        <a href="./home/articles.html" class="link">See more contents</a>
      </div>
    </section>
    ...
    <section id="testimonies">
      <div class="container">
        ...
        <div class="testimony-container">
          ...
          <div class="testimony-box">
            <div>
              ...
              <div class="title">
                <p class="name">Mark Frenchy</p>
                <span class="country text-muted">Gabon</span>
              </div>
            </div>
            <div class="testimony-content">
        ...
        <div class="btn-container">
          <a href="contact/testimonies" class="btn btn-white">Add Your Testimony</a
          ><a href="testimonies" class="btn">View More</a>
        </div>
      </div>
    </section>
    ...
    <section id="featured-products">
      <div class="container">
        ...
        <div class="product-container">
          <div class="product-box book-card">
    ...
    <section id="featured-videos">
      <div class="container">
        <h2 class="header">Featured Videos</h2>
        ...
        <div class="video-container">
          <div class="videos">
            ...
            <div class="video-card">
              ...
              <h3 class="video-title">THE WORD OF HIS POWER By Prophet Kevin N.</h3>
              <p class="share">
                Help Us Reach More People By Sharing This Video To Others.
              </p>
              <div class="video-btns">
                <a href="facebook.com/prophetkevinonline" class="btn fb">
                  <i class="bx bxl-facebook"></i>
                  <p>Share On Facebook</p>
                </a>
                <a href="youtube.com/prophetkevinonline" class="btn yt">
            ...
            <div class="video-card">
              ...
              <h3 class="video-title">STANDING COMPLETE IN ALL THE WILL OF GOD By Prophet Kevin N.</h3>
              <p class="share">
                Help Us Reach More People By Sharing This Video To Others.
              </p>
              <div class="video-btns">
          ...
          <div class="side-news">
            <div class="side-news-card">
              ...
              <div class="side-news-text">
                ...
                <a href="salvation" class="btn">Receive Christ</a>
              </div>
            </div>
            <div class="subscribe">
              <div>
            ...
            <div class="side-news-card">
              ...
              <div class="side-news-text">
                ...
                <a href="contact/partner" class="btn">Become a partner</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="faqs-section">
      <div class="container container-faqs-section">
        ...
        <div class="more-questions">
          ...
          <a href="contact/questions" class="btn">Contact Us</a>
        </div>
      </div>
    </section>
